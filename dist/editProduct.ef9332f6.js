...
$(document).ready(function() {
    ...
    $("#update").on("click", ()=>{
        const product = new (0, _productDefault.default)(categoryIdCrl.val(), productIdCrl.val(), nameCrl.val(), descriptionCrl.val(), priceCrl.val(), quantityCrl.val(), imageCrl.val());
        try {
...
},{"regenerator-runtime/runtime":"dXNgZ","./constants/FirebaseConstants":"ar8Y5","./helpers/UrlHelper":"9C87C","./models/Product":"b4We3","./services/CategoryService":"1bIMI","./services/ProductService":"63Op7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9C87C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gvM1L","IO2EM"], "IO2EM", "parcelRequire5df1")
